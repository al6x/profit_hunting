...
In my opinion: **right tail ν=3.1, left tail ν=3.1**, for all 1d-1095d periods and volatility
levels.
...
Right Tail by Vol raw x=survx, y=survycolor=vol_dc(cohort), dashed=survy_m by=period

![Right Tail by Vol raw x=survx, y=survycolor=vol_dc(cohort), dashed=survy_m by=period](readme/right-tail-by-vol-raw-x-survx-y-survycolor-vol-dc-cohort-dashed-survy-m-by-period.png)

Right Tail by Vol x=survxn, y=survycolor=vol_dc(cohort), dashed=survy_m by=period

![Right Tail by Vol x=survxn, y=survycolor=vol_dc(cohort), dashed=survy_m by=period](readme/right-tail-by-vol-x-survxn-y-survycolor-vol-dc-cohort-dashed-survy-m-by-period.png)
...
Left Tail by Vol raw x=survx, y=survycolor=vol_dc(cohort), dashed=survy_m by=period

![Left Tail by Vol raw x=survx, y=survycolor=vol_dc(cohort), dashed=survy_m by=period](readme/left-tail-by-vol-raw-x-survx-y-survycolor-vol-dc-cohort-dashed-survy-m-by-period.png)

Left Tail by Vol x=survxn, y=survycolor=vol_dc(cohort), dashed=survy_m by=period

![Left Tail by Vol x=survxn, y=survycolor=vol_dc(cohort), dashed=survy_m by=period](readme/left-tail-by-vol-x-survxn-y-survycolor-vol-dc-cohort-dashed-survy-m-by-period.png)
